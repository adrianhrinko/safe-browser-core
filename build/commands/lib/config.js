...
Config.prototype.buildArgs = function () {
  ...
  if (this.targetOS === 'android') {
    ...
    if (!this.isOfficialBuild()) {
      ...
      args.chrome_public_manifest_package = 'com.safe.browser_default'
    } else if (this.channel === '') {
      args.android_channel = 'stable'
      args.chrome_public_manifest_package = 'com.safe.browser'
    } else if (this.channel === 'beta') {
      args.chrome_public_manifest_package = 'com.safe.browser_beta'
    } else if (this.channel === 'dev') {
      args.chrome_public_manifest_package = 'com.safe.browser_dev'
    } else if (this.channel === 'nightly') {
      args.android_channel = 'canary'
      args.chrome_public_manifest_package = 'com.safe.browser_nightly'
    }
